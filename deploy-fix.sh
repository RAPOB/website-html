...
mkdir -p /home/REDACTED/public_html/

# Copy files with explicit permissions
if [ -f "index.php" ]; then
    cp index.php /home/REDACTED/public_html/
    chmod 644 /home/REDACTED/public_html/index.php
    echo "✓ Copied index.php"
fi

if [ -f ".htaccess" ]; then
    cp .htaccess /home/REDACTED/public_html/
    chmod 644 /home/REDACTED/public_html/.htaccess
    echo "✓ Copied .htaccess"
fi

if [ -f "robots.txt" ]; then
    cp robots.txt /home/REDACTED/public_html/
    chmod 644 /home/REDACTED/public_html/robots.txt
    echo "✓ Copied robots.txt"
fi

if [ -f "sitemap.xml" ]; then
    cp sitemap.xml /home/REDACTED/public_html/
    chmod 644 /home/REDACTED/public_html/sitemap.xml
    echo "✓ Copied sitemap.xml"
fi

if [ -d "images" ]; then
    cp -r images /home/REDACTED/public_html/
    chmod 755 /home/REDACTED/public_html/images
    chmod 644 /home/REDACTED/public_html/images/*
...
chmod 755 /home/REDACTED/public_html/
...
if [ -f "/home/REDACTED/public_html/index.php" ]; then
    echo "✓ index.php deployed ($(stat -c%s /home/REDACTED/public_html/index.php) bytes)"
else
    echo "✗ index.php not found in public_html"
fi

if [ -f "/home/REDACTED/public_html/.htaccess" ]; then
